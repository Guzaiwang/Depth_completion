...
cd ../src
python3 main_w_Vis.py --dir_data /DATA/i2r/guzw/workspace/3D/nyudepthv2 --data_name NYU  --split_json ../data_json/nyu.json --gpus 6 --max_depth 10.0 --num_sample 500 --save_image \
    --test_only --pretrain /DATA/i2r/guzw/workspace/confidence/CompletionFormer/experiments/231117_155407_train_nyu_w_confidence_from_epoch0/model_00040.pt --log_dir ../experiments/Vis/ --save w_confidence_from_epoch0_ckpt_40 >> ../logs/Vis_w_confidence_from_epoch0_ckpt_40_rmse.txt 2>&1 &
