...
import utility
from model.completionformer_w_unc import CompletionFormer
from summary.cfsummary import CompletionFormerSummary
from metric.cfmetric import CompletionFormerMetric, CompletionFormerMetric_w_confidence
from data import get as get_data
from loss.l1l2loss import L1L2wConfidence
from loss.l1l2loss import L1L2wUnC as L1L2Loss
...
def train(gpu, args):
    ...
    loss = L1L2Loss(args)
    loss.cuda(gpu)
    loss_confidence = L1L2wConfidence(args)
    loss_confidence.cuda(gpu)
    ...
    metric = CompletionFormerMetric_w_confidence(args)
    ...
    for epoch in range(start_epoch, args.epochs+1):
        ...
        for batch, sample in enumerate(loader_train):
            ...
            loss_sum, loss_val = loss_confidence(sample, output, first_output)
