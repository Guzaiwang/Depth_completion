...
from .backbone_w_unc import Backbone
import torch
...
class CompletionFormer(nn.Module):
    ...
    def forward(self, sample):
        ...
        pred_init, guide, confidence, init_unc = self.backbone(rgb, dep)
        ...
        output = {'pred': y, 'pred_init': pred_init, 'pred_inter': y_inter,
                  ...
                  'gamma': aff_const, 'confidence': conf_inter, 'uncertainty': init_unc}
