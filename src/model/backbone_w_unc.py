...
class Backbone(nn.Module):
    def __init__(self, args, mode='rgbd'):
        ...
        # Init uncertainty Branch
        self.unc_dec0 = conv_bn_relu(64+64, 1, kernel=3, stride=1,
    ...
    def forward(self, rgb=None, depth=None):
        ...
        init_unc = torch.sigmoid(self.unc_dec0(self._concat(dep_fd1, fe1)))
        ...
        return init_depth, guide, confidence, init_unc
